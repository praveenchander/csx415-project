...
## Deliverables: 
R Markdown document/Shiny R for user interface with inferences
...
## Approach:
1. Applying Classification Random Forest algorithm
2. Applying Classification Support Vector Machines algorithm
3. Calculate the performance metric between two approaches
4. Provide capability for end user to enter any record and predict what are the outputs of each method
